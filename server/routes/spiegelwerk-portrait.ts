/**
 * Spiegelwerk Portrait Generator — Server Route
 * Roept de Claude API aan om een persoonlijk portret te genereren
 * op basis van de Spiegelwerk-testscores.
 *
 * Bestand: server/routes/spiegelwerk-portrait.ts
 */
...
function buildSystemPrompt(): string {
  return `Je bent een ervaren, warm en psychologisch geschoold schrijver die werkt in de traditie van de lichaamsgerichte psychotherapie (Reich, Lowen, Pierrakos). Je schrijft persoonlijke portretten voor deelnemers die Spiegelwerk hebben ingevuld — een test die zes karakterstructuren meet.
...
1. Titel: "Jouw Spiegelwerk-portret"
...
function buildUserPrompt(data: {
  ...
  let prompt = `Schrijf een persoonlijk Spiegelwerk-portret voor iemand met het volgende profiel:
