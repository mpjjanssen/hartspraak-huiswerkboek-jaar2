...
export default function Workshop3() {
  const questions = [
    ...
    },
    {
        ...
        "fullText": "Vraag: Jij hebt discipline en vormkracht. Als je deze niet gebruikt om jezelf te beschermen of te verharden, maar om voluit lief te hebben en schoonheid te creëren, hoe ziet jouw leven er dan uit?\nVerdiepende vraag: Kun je een moment herinneren waarop je écht open was, zonder harnas, en het goed was? Wat maakte dat moment mogelijk, en hoe kun je meer van die momenten creëren?\n\"Doorleefde performende energie maakt het mogelijk om voluit in de liefde te staan door hart- en bekkenenergie met elkaar te verbinden. De essentie van deze structuur zit in oog hebben voor de innerlijke schoonheid van ieder mens.\"\n(Bron: De Maskermaker, Hoofdstuk 9)\nTer afsluiting:\nDe performende structuur vraagt ons om de controle te verliezen. Dat klinkt als sterven, maar het is de enige weg naar echt leven. Zoals ik in het boek schrijf: \"Faal vandaag ergens in. Niet dramatisch, maar gewoon menselijk.\"\nIk zie ernaar uit om samen met jullie het harnas af te leggen.\nMartien"
    }
];
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xl text-muted-foreground">
                De strategische en performende structuur
              </p>
            </div>
          </div>
