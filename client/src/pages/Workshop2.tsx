          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xl text-muted-foreground">
                De versmeltende en dragende structuur
              </p>
            </div>
          </div>
